...
enum class Theme(override val text: Int? = null, override val iconId: Int? = null) : ITabs {
    Sun(iconId = R.drawable.ic_sun), 
    Auto(text = R.string.auto), 
    Moon(iconId = R.drawable.ic_moon),
    SolarizedLight(text = R.string.solarized_light);
